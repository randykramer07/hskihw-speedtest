...
var (
		...
		loadedConfig *Config = nil // Stelt configuratie in van het geladen configuratiebestand , anders wordt alles op 0 gezet.
)
...
func LoadedConfig() *Config {  // Gebruik de eerder geladen Configuratie in de string configuratieBestand
	if loadedConfig == nil { // Als loadedConfig == nil (oftewel er is geen configuratiebestand geladen), laad dan configuratieBestand
			Load(configuratieBestand)
	}
	return loadedConfig // Veranderd loadedConfig
}